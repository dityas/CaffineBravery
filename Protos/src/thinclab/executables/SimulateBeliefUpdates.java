...
public class SimulateBeliefUpdates {
    ...
    public static void runSimulator(final PBVISolvablePOMDPBasedModel model,
        ...
        while (true) {
            ...
            var rew = DDOP.dotProduct(b_i, 
                    model.R().get(aIndex), model.i_S());
            totalReward += rew;
    ...
    public static void main(String[] args) throws Exception {
        ...
        opt.addOption("biased", false, "model biased agents");
        ...
        PBVISolvablePOMDPBasedModel model = (PBVISolvablePOMDPBasedModel)
            parser.getModel(modelName).orElseGet(() ->
                    {
        ...
        if (Global.MODEL_BIASED && model.getName().startsWith("att"))
            model.setBiased();
